...
def convert_to_yolov8(
    train_txt_path="./plate-number/Train.txt",  # Relative path to Train.txt
    images_dir="./plate-number/images/train/",  # Relative path to images
    labels_dir="./plate-number/labels/train/",  # Relative path to labels
    output_dir="./output/",  # Relative path for output
    val_split=0.2
):
    """
